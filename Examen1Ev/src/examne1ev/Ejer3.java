...
public class Ejer3 {
	...
	public static void main (String[] args) {
		...
		if(correcto == true) {
			...
			//CUENTA LOS DIAS DESDE EL 1/1/DEL PRIMER AÑO AL 1/1/DEL SEGUNDO AÑO
			for(cont=0;a1<a2;++a1) {
				if(a1%4==0 ) {
					if(a1%100==0) {
			...
			//RESTA LOS MESES QUE YA HAN PASADO DEL AÑO EN LA PRIMERA FECHA
			for(n=1;n<m1;++n) {
				if(n==1 || n==3 || n==5 || n==7 || n==8 || n==10 || n==12)cont-=31;
				else if(n == 2)cont-=28;
				else if(n==4 || n==6 || n==9 || n==11)cont-=30;
			}
			//SUMA LOS MESES QUE YA HAN PASADO DEL AÑO EN LA SEGUNDA FECHA
			for(n=1;n<m2;++n) {
				if(n==1 || n==3 || n==5 || n==7 || n==8 || n==10 || n==12)cont+=31;
				else if(n == 2)cont+=28;
				else if(n==4 || n==6 || n==9 || n==11)cont+=30;
			...
			cont+=d2-d1;
			System.out.println(cont+" días");
		}
		else System.out.println("Alguna de las fechas introducidas es errónea");
	}
}